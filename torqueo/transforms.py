...
class PolarCoordinates(WarpTransform):
    """
    Applies a polar coordinate distortion effect which converts image from cartesian to polar coordinate system. 
    There are no parameters as input to this transform. 
    ...
    def generate_warp_field(self, height, width):
        """
        Generates the warp field for the polar coordinate distortion.
        ...
        theta_normalized = (theta + torch.pi)/(torch.pi) - 1
